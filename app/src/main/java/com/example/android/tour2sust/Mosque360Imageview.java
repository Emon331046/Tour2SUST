...
public class Mosque360Imageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mosque360_imageview);   //----$$$$$$$ change
        ...
        protected Boolean doInBackground(Pair<Uri, VrPanoramaView.Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    ...
                    istr = assetManager.open("central_mosque_361.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Mosque360Imageview.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
