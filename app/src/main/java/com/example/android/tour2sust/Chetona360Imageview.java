...
public class Chetona360Imageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chetona360_imageview);   //----$$$$$$$ change
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    ...
                    istr = assetManager.open("chetona_71_361.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Chetona360Imageview.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
