...
public class ShahidMinar360Imageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shahid_minar360_imageview);   //----####^^&&&$$$EMON$$$$ change
    ...
    class ImageLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    //MMMMMMMMMMMMMMMMMchange filename that will change imagesMMMMMMMMMMMMMMMMMM
                    istr = assetManager.open("shahid_minar_361.jpg"); //----####^^&&&$$$EMON$$$$ change
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    ShahidMinar360Imageview.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();    //----####^^&&&$$$EMON$$$$ change
