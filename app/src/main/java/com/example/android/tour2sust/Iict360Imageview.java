...
public class Iict360Imageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iict360_imageview);   //----####^^&&&$$$EMON$$$$ change
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    ...
                    istr = assetManager.open("IICT_361.jpg"); //----####^^&&&$$$EMON$$$$ change
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Iict360Imageview.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();    //----####^^&&&$$$EMON$$$$ change
