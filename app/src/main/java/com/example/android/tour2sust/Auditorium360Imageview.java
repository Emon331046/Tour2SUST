...
public class Auditorium360Imageview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auditorium360_imageview);
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    ...
                    istr = assetManager.open("audi_361.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Auditorium360Imageview.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
